---
name: "Audit logs miss failed auth attempts"
about: "Autter Sandbox challenge"
title: "Audit logs miss failed auth attempts"
labels: ["autter-sandbox", "observability"]
---

# Challenge: Audit logs miss failed auth attempts
...
Failed authentication attempts are not recorded.
...
Fix the issue where failed authentication attempts are not recorded.
