---
name: "Webhook retry logic duplicates delivery"
about: "Autter Sandbox challenge"
title: "Webhook retry logic duplicates delivery"
labels: ["autter-sandbox", "reliability"]
---

# Challenge: Webhook retry logic duplicates delivery
...
Retries can send the same event multiple times without idempotency.
...
Fix the issue where retries can send the same event multiple times without idempotency.
