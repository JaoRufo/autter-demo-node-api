---
name: "API key lookup allows inactive keys"
about: "Autter Sandbox challenge"
title: "API key lookup allows inactive keys"
labels: ["autter-sandbox", "auth"]
---

# Challenge: API key lookup allows inactive keys
...
Revoked API keys still authenticate successfully.
...
Fix the issue where revoked API keys still authenticate successfully.
