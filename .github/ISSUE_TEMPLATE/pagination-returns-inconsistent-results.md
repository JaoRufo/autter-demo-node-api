---
name: "Pagination returns inconsistent results"
about: "Autter Sandbox challenge"
title: "Pagination returns inconsistent results"
labels: ["autter-sandbox", "data"]
---

# Challenge: Pagination returns inconsistent results
...
Pagination changes when records are created between requests.
...
Fix the issue where pagination changes when records are created between requests.
