---
name: "Zod validation strips fields incorrectly"
about: "Autter Sandbox challenge"
title: "Zod validation strips fields incorrectly"
labels: ["autter-sandbox", "validation"]
---

# Challenge: Zod validation strips fields incorrectly
...
Valid nested config fields are silently dropped during validation.
...
Fix the issue where valid nested config fields are silently dropped during validation.
